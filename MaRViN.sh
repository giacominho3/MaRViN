...
str=", crearvi una cartella chiamata "
print_animated "$str" "$WHITE"
...
str=": Ricorda che questo comando lo dovrai ripetere in tutti i livelli per verificarne le soluzioni."
print_animated "$str" "$WHITE"
...
str=": Good luck! Have fun! Dont't die!"
print_animated "$str" "$WHITE"
